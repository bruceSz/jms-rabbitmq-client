...
import jms.rabbitmq.jms.Session;
 ...
 * @param <P>
 */
public class AMQSession<C extends BasicMessageConsumer, P extends BasicMessageProducer> extends Closable implements Session, QueueSession, TopicSession{
